...
const TracksCarousel = ({ songs, songsDb }: TracksCarouselProps) => {
  ...
  // Check if tracks is an array before proceeding
  if (!Array.isArray(tracks)) {
    console.error("Error: tracks data is invalid:", tracks);
    return <div>Error: Tracks data is invalid.</div>; // Optional error UI
  }
